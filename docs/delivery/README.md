...
| 7 | AI Agents | ✅ | 6 agents + supervisor, **mémoire** (tenant) + **eval routage** (/agents/eval) ; 🟡 tool-calling avancé |
| 8 | LLM Platform | ✅ | Claude/Mistral, structured output, conversation history, **RAG pgvector** (/rag) ; 🟡 prompt versioning, guardrails |
...
| 13 | Monitoring | ✅ | logs corrélés (**tracing** request_id/trace_id), metrics, health, MLOps ; 🟡 cost, OTEL prod |
